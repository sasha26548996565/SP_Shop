...
@section('content')
    ...
    <ul class="breadcrumbs flex flex-wrap gap-y-1 gap-x-4 mb-6">
        ...
        <li><a href="{{ route('wishlist') }}" class="text-body hover:text-pink text-xs">Избранное</a></li>
    </ul>

    <section class="mt-16 lg:mt-24">
        <!-- Section heading -->
        <h2 class="text-lg lg:text-[42px] font-black">Избранные вами товары</h2>
        ...
        <div class="flex flex-col lg:flex-row gap-12 lg:gap-6 2xl:gap-8 mt-8">
            ...
            <div class="basis-auto xl:basis-3/4">
                ...
                <div
                    ...
                    @each('wishlist.shared.offer', $offers, 'offer')
                </div>

                <!-- Page pagination -->
                <div class="mt-12">
                    {{ $offers->withQueryString()->links('pagination::tailwind') }}
                </div>
            </div>
        </div>
